...
def neural_coding(images: torch.Tensor, args) -> torch.Tensor:
    ...
    Args:
        ...
        args (any): parsed arguments. See utils/args_snntorch.py.

    Raises:
        NotImplementedError: If a certain neural coding is not implemented

    Returns:
        torch.Tensor: Resulting spiketrains of dimestion (T, B, C, H, W) where T is the total number of timesteps (i.e. args.timesteps)
    """
